...
<div class="p-wrapper">
	<div class="content">
		...
		<table width="95%" border="0" cellspacing="0" cellpadding="0" style="margin-left:15px;">
			<tr>
				...
				<td width="28%">
					...
					<input type="text" name="kode" id="kode" class="pasif" value="<?php echo $dtbarang->getField('barcode',$id);?>" readonly="" />		
				</td>
				<td width="13%">&nbsp;</td>
				...
				<td width="31%" align="right">
					...
					<input type="hidden" name="harga_jual" id="harga_jual" value="<?php echo $dtbarang->getField('harga_jual',$id);?>" />
				</td>
			</tr>
                <tr>
			...
			<tr>
                ...
                <td align="right"><input type="text" name="jumlah" id="jumlah" readonly="" style=" text-align:right; border:none; background:none;font-size:18px; font-weight:bold; color:#D70000;" />
				  <input type="hidden" id="idt" value="<?php echo kode('dtbarangmasuk',$logid);?>">
				</td>
        	</tr>
  		</table>
		</form>	
		...
		<div class="head_content" style="box-shadow:none;" >
		  <input name="kembali" id="kembali" type="button" value="Kembali" onClick="history.back();" style="float:right" />
		  <input name="tambah" id="tambah" type="button" value="Tambah" onClick="addTemp();" />
