...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr>
		  ...
		  <td width="20%" style="border:none;">: <?php echo getTanggal($trxout->getHeadField('tanggal',$id)); ?></td>
		</tr>
		<tr>
			<td align="left" style="border:none;"><strong>PENGAJUAN OLEH </strong></td>
			<td align="left" style="border:none;">: <?php echo $pegawai->getField('jabatan',$trxout->getHeadField('pemohon',$id)); ?></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="tbl">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			...
			<td align="center" style="border:none;"><p>( <?php echo $pegawai->getField('nama',$trxout->getHeadField('id_user',$id)); ?> )</p></td>
		</tr>
	</table>
<?php
}else{
