<?php
$linkdata='page/barang/trxcodeprc.php';
?>
<script>
	...
	function prn(){
		var prnbarkode=null;
		if (prnbarkode==null){
			prnbarkode=open('page/barang/prnbarcode.php','page','navigator=0,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,left=50,right=50,top=50,buttom=50,titlebar=0,width=750,height=600');
		}
	}
	function getBrg(){
		$.ajax({
