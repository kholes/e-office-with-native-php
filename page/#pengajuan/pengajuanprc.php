				...
				<table cellpadding="0" cellspacing="0" width="99%">
					<tr>
						...
						<td width="24%" style="background:#ccc">
							<input type="text" class="tgl" name="tanggal" id="tanggal<?php echo $id;?>" value="<?php echo $date->format('d-m-Y'); ?>"  onclick="return showCalendar('tanggal<?php echo $id;?>', 'dd-mm-y')" style="width:200px;"/>
					  	</td>
						...
						switch($level){
							case 'STB':$val_btn='Proses';
								...
								<tr>
									...
									<td width="5%" align="center"><?php echo $dtbarang->getField('stok',$row['id']);?></td>
