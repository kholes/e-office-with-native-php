...
<div id="thick-wrapper">
	...
	<div id="thick-frm">
		<form method="post" action="<?php echo $link;?>" enctype="multipart/form-data" id="MyForm">
			...
			<div>
			<h3 align="left">&raquo; PERALATAN DAN MESIN</h3>
			<table width="100%" cellpadding="0" cellspacing="0" id="thick-tbl">
				<tr>
					<td width="16%" rowspan="2">Jenis / Nama Barang</td>
					<td width="24%" rowspan="2">Merek/Type</td>
					<td width="10%" rowspan="2">Ukuran/cc</td>
					<td width="6%" rowspan="2">Bahan</td>
					<td width="9%" rowspan="2">Th.Pembelian</td>
					<td colspan="5" align="center">Nomor</td>
				  <td width="5%" rowspan="2">Terpilih</td>
				</tr>
				<tr>
					<td width="6%">Pabrik</td>
					<td width="6%">Rangka</td>
					<td width="6%">Mesin</td>
					<td width="6%">Polisi</td>
					<td width="6%">BPKB</td>
				</tr>
				<?php
