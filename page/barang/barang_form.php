...
$(document).ready(function(){
	...
	$('#hapus').click(function(){
		$.ajax({
			type: 'POST',
			url: '<?php echo $link;?>&m=barangform',
...
<div class="p-wrapper">
	<div class="content">
		<div id="label-form">
			<li class="fa fa-file">   <label>REGISTRASI DATA BARANG</label></li>
			<a href="<?php echo $link;?>"><li class="fa fa-times icon-small" style="float:right"></li></a>
		</div>
		<div class="c"></div>
		<form method="post" action="<?php echo $link; ?>&m=barangform" enctype="multipart/form-data" id="MyForm">
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	switch ($_POST['btn']){
		case 'Simpan':
			...
			header("location:$link&m=barangform");
		break;
		case 'Edit':
			$data=array('id'=>$_POST['id'],'barcode'=>$_POST['barcode'],'kategori'=>$_POST['kategori'],'nama'=>$_POST['nama'],'merek'=>$_POST['merek'],'satuan'=>$_POST['satuan'],'stok'=>$_POST['stok'],'minstok'=>$_POST['minstok']);
