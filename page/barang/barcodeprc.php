	...
	?>
		...
		?>
		  <tr>
			...
			<td width="3%"><a onClick="editTemp('<?php echo $row['id_brg'];?>');"><li class="fa fa-pencil-square-o icon-small"></li></a></td>
			<td width="3%"><a onClick="delTemp('<?php echo $row['id_brg'];?>');"><li class="fa fa-trash-o icon-small"></li></a></td>
		  </tr>
		<?php
		}
		?>
