	...
	function getRem(){
		$.ajax({type:'post',url:'<?php echo $linkdata; ?>',data:'btn=getRem&mail=in&sts=all',cache :false,success:function (data){$('#infRem').html(data);}});
					...
					<ul>
						<li class="menutip">
							...
							<span><b></b>
								<ul>
									...
									<li><a style="color:#fff" href="<?php echo $link; ?>&m=fsuratkeluar">Registrasi Surat Keluar</a></li>
									<li><a style="color:#fff" href="<?php echo $link; ?>&m=fdraftsurat">Surat Keluar</a></li>
									<li><a class="thickbox" style="color:#fff" href="page/surat/frmsuratrhs.php?width=400 height=300">Registrasi Surat Rahasia</a></li>
						...
						<li><a href="<?php echo $link; ?>&m=dtoutbox&sts=terkirim">Surat Keluar <span class="counter" id="infOut"></span></a></li>
